...
// Địa chỉ I2C phổ biến của LCD 16x2 là 0x27 (Dịch trái 1 bit thành 0x4E)
// Nếu không chạy, hãy thử đổi thành 0x7E (0x3F << 1)
...
void lcd_init (void) {
    ...
    lcd_send_cmd (0x01); HAL_Delay(1); HAL_Delay(2);
